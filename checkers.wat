(module
  ;; Import external event functions
  (import "events" "piecemoved"
    (func $notify_piecemoved
      (param $fromX i32)
      (param $fromY i32)
      (param $toX i32)
      (param $toY i32)))
  ...
  (import "events" "piececrowned"
    (func $notify_piececrowned
      (param $pieceX i32)
      (param $pieceY i32))
  )

  ;; Module program starts here
  (memory $mem 1)
  ...
  ;; Converts a piece into a crowned piece and invokes a notifier
  ...
  ;; Exported move function to be call by the game host
  ...
  ;; Internal move function, performas actual move port-validation of target.
  ...
  (func $initBoard
    ...
    ;; Skip other set piece statements for now
